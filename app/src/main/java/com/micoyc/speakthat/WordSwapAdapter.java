...
public class WordSwapAdapter extends RecyclerView.Adapter<WordSwapAdapter.ViewHolder> {
    ...
    public WordSwapAdapter(List<FilterSettingsActivity.WordReplacementItem> items, 
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_word_swap, parent, false);
