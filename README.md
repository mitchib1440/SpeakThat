...
SpeakThat’s code heavily makes use of AI-assisted programming. While I do my best to vet code used in the project and of course test new versions of the app on both my own devices as well as emulated devices before any of it goes public, there always exists the possibility for errors and faults to slip through into release. As you should expect, I take full responsibility for these mistakes and ask for your understanding as I work through them.
